...
The most error-prone cross-reference is `'ALIAS'`.
Each step up the chain has more confidence.
So it makes sense to start with the highest confidence,
at the top of the list,
then proceed down the list, only as needed.
